...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <h2 className="mt-10 text-xl font-semibold text-brand-teal-dark">What Arabs Finder is</h2>
      <p className="mt-3 text-foreground/80">
        Arabs Finder is an interactive computer service that hosts user-generated content, including business
        listings, claims, and — where enabled — reviews and comments. As such, and consistent with Section 230 of
        the Communications Decency Act, Arabs Finder is not the publisher or speaker of content submitted by users or
        businesses.
      </p>

      <h2 className="mt-10 text-xl font-semibold text-brand-teal-dark">We don't rewrite what you say</h2>
      <p className="mt-3 text-foreground/80">
        Staff never edit, paraphrase, or rewrite a user's review or a business's self-description into Arabs Finder's
        own editorial voice. Any claim that a business is Arab-owned must be made explicitly by the business itself —
        Arabs Finder does not assert it on a business's behalf.
      </p>
      ...
      <p className="mt-3 text-foreground/80">
        ...
        default. Arabs Finder, its staff, and its contractors never write reviews to seed a listing. First-party
      ...
      <p className="mt-3 text-foreground/80">
        Consistent with California State Bar Rule 7.2(b) and the federal Anti-Kickback Statute / Stark Law, Arabs
      ...
      <p className="mt-3 text-foreground/80">
        Arabs Finder does not recommend, refer, or verify the professional competence of any listed provider. Where a
