  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      ...
      <p className="mt-3 text-foreground/80">
        Arabs Finder never infers or guesses Arab identity or ownership from a name, photograph, spoken language,
        ...
        public statement the business itself has published and that Arabs Finder can cite. Every other listing —
      ...
      <p className="mt-3 text-foreground/80">
        Arabs Finder does not copy, cache, or store business listings scraped from Google Maps or Yelp — both
      ...
      <p className="mt-3 text-foreground/80">
        ...
        that Arabs Finder does not recommend, refer, or verify professional competence, and shown license numbers
        should always be checked directly with the relevant state licensing board. Arabs Finder does not charge
